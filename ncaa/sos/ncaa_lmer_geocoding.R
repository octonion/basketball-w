...
dbWriteTable(con,c("ncaa","_parameter_levels_geocoding"),parameter_levels,row.names=TRUE)
...
dbWriteTable(con,c("ncaa","_basic_factors_geocoding"),as.data.frame(combined),row.names=TRUE)
...
jpeg("ncaa_geocoding_shapiro-francia.jpg")
...
jpeg("ncaa_geocoding_fitted_vs_residuals.jpg")
plot(f,r)
jpeg("ncaa_geocoding_q-q_plot.jpg")
