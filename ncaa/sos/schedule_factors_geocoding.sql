...
create table if not exists ncaa._schedule_factors_geocoding (
        school_id		integer,
	year			integer,
        offensive               float,
        defensive		float,
...
truncate table ncaa._schedule_factors_geocoding;
...
r.field
from ncaa.results r
where r.year between 2002 and 2018
);
...
strength=o.strength
from ncaa._schedule_factors_geocoding o
...
from ncaa._factors_geocoding f
...
from rs
where
  (_schedule_factors_geocoding.school_id,_schedule_factors_geocoding.year)=
